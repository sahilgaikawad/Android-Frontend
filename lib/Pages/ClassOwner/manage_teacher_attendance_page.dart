...
class _AttendanceHistoryDialogContentState extends State<_AttendanceHistoryDialogContent> {
  ...
  Future<void> _fetchHistory() async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse('http://192.168.1.103:5001/api/attendance/teacher/history/$teacherId'),
        headers: {'Authorization': 'Bearer $token'},
      );
  ...
  Future<void> _updateRecord(String recordId, String status) async {
    try {
      ...
      final response = await http.put(
        Uri.parse('http://192.168.1.103:5001/api/attendance/teacher/record/$recordId'),
  ...
  Future<void> _deleteRecords(List<dynamic> recordIds) async {
    try {
      ...
      final response = await http.delete(
        Uri.parse('http://192.168.1.103:5001/api/attendance/teacher/records'),
        headers: { 'Content-Type': 'application/json', 'Authorization': 'Bearer $token' },
