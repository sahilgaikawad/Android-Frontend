...
class _TeacherMarkAttendancePageState extends State<TeacherMarkAttendancePage> {
  ...
  Future<void> _fetchAssignedClasses() async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse('http://192.168.1.103:5001/api/teacher/profile/my-classes'),
  ...
  Future<void> _fetchAttendanceData() async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse('http://192.168.1.103:5001/api/attendance/student?date=$formattedDate&standard=$_selectedClass'),
        headers: {'Authorization': 'Bearer $token'},
  ...
  Future<void> _saveAttendance() async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('http://192.168.1.103:5001/api/attendance/student'),
